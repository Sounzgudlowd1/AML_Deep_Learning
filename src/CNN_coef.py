...
def correlation_coefficient_loss(y_true, y_pred,size=last_images-start_images):
    size=size*0.8   
    x = y_true
    y = y_pred
    mx = K.mean(x)
    ...
    r=1-K.square(r) * (size-1)/(size-2500-1)      
    r=1-r                     
    return 1 - r    
...
with open('coef/adam_train.txt', 'w') as file:
    ...
    for item in h1.history['acc']:
      file.write("%s\n" % item)
with open('coef/adam_test.txt', 'w') as file:
    file.write("%s\n" % 0.0)
...
with open('coef/sgd_train.txt', 'w') as file:
    file.write("%s\n" % 0.0)
    for item in h2.history['acc']:
      file.write("%s\n" % item)
      
with open('coef/sgd_test.txt', 'w') as file:
    file.write("%s\n" % 0.0)
...
with open('coef/ada_train.txt', 'w') as file:
    file.write("%s\n" % 0.0)
    for item in h3.history['acc']:
      file.write("%s\n" % item)
      
with open('coef/ada_test.txt', 'w') as file:
    file.write("%s\n" % 0.0)
...
with open('coef/rms_train.txt', 'w') as file:
    ...
    for item in h4.history['acc']:
      file.write("%s\n" % item)
with open('coef/rms_test.txt', 'w') as file:
    file.write("%s\n" % 0.0)
...
a2=[]
with open('coef/adam_test.txt') as f:
    for line in f:
        v=float(line)
        a2.append(v)
        #np.vstack((n,line))
...
s=[]   
with open('coef/sgd_train.txt') as f:
    for line in f:
        v=float(line)
        s.append(v)
        #np.vstack((n,line))
...
s2=[]
with open('coef/sgd_test.txt') as f:
    for line in f:
        v=float(line)
        s2.append(v)
        #np.vstack((n,line))
...
ada=[]   
with open('coef/ada_train.txt') as f:
    for line in f:
        v=float(line)
        ada.append(v)
        #np.vstack((n,line))
...
ada2=[]
with open('coef/ada_test.txt') as f:
    for line in f:
        v=float(line)
        ada2.append(v)
        #np.vstack((n,line))
...
rms=[]   
with open('coef/rms_train.txt') as f:
    for line in f:
        v=float(line)
        rms.append(v)
        #np.vstack((n,line))
...
rms2=[]
with open('coef/rms_test.txt') as f:
    for line in f:
        v=float(line)
        rms2.append(v)
        #np.vstack((n,line))
...
plt.savefig('coef/training_accuracy_curve.png')
